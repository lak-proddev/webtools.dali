...
public interface NamedStoredProcedureQuery3_0 extends Query {
	 ...
	 */
	ListIterable<? extends StoredProcedureParameter3_0> getParameters();
	 ...
	 */
	StoredProcedureParameter3_0 addParameter();

	/**
	 * Add a parameter to the index and return the object representing it.
	 */
	StoredProcedureParameter3_0 addParameter(int index);

	/**
	 * Remove the parameter from the query.
	 */
	void removeParameter(StoredProcedureParameter3_0 parameter);
	 ...
	 */
	StoredProcedureParameter3_0 getParameter(int index);
