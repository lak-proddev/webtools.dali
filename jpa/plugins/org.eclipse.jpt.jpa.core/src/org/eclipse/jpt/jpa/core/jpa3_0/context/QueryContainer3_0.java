	...
	extends QueryContainer
{
	 ...
	 */
	ListIterable<? extends NamedStoredProcedureQuery3_0> getNamedStoredProcedureQueries();
	 ...
	 */
	NamedStoredProcedureQuery3_0 addNamedStoredProcedureQuery();

	/**
	 * Add a new named stored procedure query to the container at the specified index
	 * and return it.
	 */
	NamedStoredProcedureQuery3_0 addNamedStoredProcedureQuery(int index);
	 ...
	 */
	void removeNamedStoredProcedureQuery(NamedStoredProcedureQuery3_0 namedStoredProcedureQuery);
