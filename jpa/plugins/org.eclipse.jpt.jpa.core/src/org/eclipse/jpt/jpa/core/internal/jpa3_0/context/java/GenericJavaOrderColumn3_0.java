 ...
 * Java order column
 */
public class GenericJavaOrderColumn3_0
		extends AbstractJavaNamedColumn<JavaSpecifiedOrderColumn3_0.ParentAdapter, OrderColumnAnnotation3_0>
		implements JavaSpecifiedOrderColumn3_0 {
	...
	public GenericJavaOrderColumn3_0(JavaSpecifiedOrderColumn3_0.ParentAdapter parentAdapter) {
		super(parentAdapter);
	...
	@Override
	protected void initialize(OrderColumnAnnotation3_0 columnAnnotation) {
	...
	@Override
	public void synchronizeWithResourceModel(OrderColumnAnnotation3_0 columnAnnotation) {
	...
	protected Boolean buildSpecifiedNullable(OrderColumnAnnotation3_0 columnAnnotation) {
	...
	public boolean isInsertable() {
		return (this.specifiedInsertable != null) ? this.specifiedInsertable.booleanValue()
				: this.isDefaultInsertable();
	}
	...
	protected Boolean buildSpecifiedInsertable(OrderColumnAnnotation3_0 columnAnnotation) {
	...
	protected Boolean buildSpecifiedUpdatable(OrderColumnAnnotation3_0 columnAnnotation) {
