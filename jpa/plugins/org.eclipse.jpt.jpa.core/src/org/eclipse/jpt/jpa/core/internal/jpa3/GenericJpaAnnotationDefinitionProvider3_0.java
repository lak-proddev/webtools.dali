 ...
 ******************************************************************************/
package org.eclipse.jpt.jpa.core.internal.jpa3;
...
public class GenericJpaAnnotationDefinitionProvider3_0 extends AbstractJpaAnnotationDefinitionProvider {
	// singleton
	private static final JpaAnnotationDefinitionProvider INSTANCE = new GenericJpaAnnotationDefinitionProvider3_0();
	...
	protected static final AnnotationDefinition[] ANNOTATION_DEFINITIONS = new AnnotationDefinition[] {
		AttributeOverridesAnnotationDefinition3_0.instance(),
		AssociationOverridesAnnotationDefinition3_0.instance(),
		AccessAnnotationDefinition3_0.instance(),
