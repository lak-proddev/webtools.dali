 ...
 */
public final class StaticMetamodelAnnotationDefinition3_0
	implements AnnotationDefinition
{
	// singleton
	private static final StaticMetamodelAnnotationDefinition3_0 INSTANCE = new StaticMetamodelAnnotationDefinition3_0();

	/**
	 * Return the singleton.
	 */
	public static StaticMetamodelAnnotationDefinition3_0 instance() {
		return INSTANCE;
	}
	 ...
	 */
	private StaticMetamodelAnnotationDefinition3_0() {
		super();
	}
