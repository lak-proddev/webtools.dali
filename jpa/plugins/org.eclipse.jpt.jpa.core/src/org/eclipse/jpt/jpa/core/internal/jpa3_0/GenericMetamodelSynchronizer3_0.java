...
import org.eclipse.jpt.jpa.core.jpa3_0.JpaMetamodelSynchronizer3_0;
...
public class GenericMetamodelSynchronizer3_0
	implements MetamodelSourceType3_0.Synchronizer
{
	protected final MetamodelSourceType3_0 sourceType;


	public GenericMetamodelSynchronizer3_0(MetamodelSourceType3_0 sourceType) {
		super();
	...
	public void synchronize(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
		try {
	...
	protected void synchronize_(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) throws JavaModelException {
	 ...
	 */
	protected String buildSource(ICompilationUnit compilationUnit, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) throws JavaModelException {
		...
		String date = ((GeneratedAnnotation3_0) genType.getAnnotation(GeneratedAnnotation3_0.ANNOTATION_NAME)).getDate();  // if we get here, this will be non-empty
	...
	protected JpaProject3_0 getJpaProject() {
		return (JpaProject3_0) this.sourceType.getJpaProject();
	}
	...
	protected String buildClassName(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
		return this.buildClassName(this.sourceType.getName(), memberTypeTree);
	}

	protected String buildClassName(String sourceTypeName, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	 ...
	 */
	protected String buildSource(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	...
	protected BodySourceWriter buildBodySourceWriter(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	...
	public void printBodySourceOn(BodySourceWriter pw, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	...
	protected void printClassDeclarationOn(BodySourceWriter pw, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	 ...
	 */
	protected boolean sourceTypeIsTopLevel(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	 ...
	 * This can be inferred from the specified member type tree.
	 */
	protected boolean sourceTypeIsTopLevel(String sourceTypeName, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	 ...
	 */
	protected String getDeclaringTypeName(String sourceTypeName, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree) {
	...
	protected void printGeneratedAnnotationOn(BodySourceWriter pw) {
		...
		pw.print('(');
		pw.print("value=");
		pw.printStringLiteral(JpaMetamodelSynchronizer3_0.METAMODEL_GENERATED_ANNOTATION_VALUE);
		pw.print(", ");
		pw.print("date=");
	...
	protected void printStaticMetamodelAnnotationOn(BodySourceWriter pw) {
		pw.printAnnotation(JPA3_0.STATIC_METAMODEL);
		pw.print('(');
	...
	protected void printAttributeMappingOn(AttributeMapping attributeMapping, BodySourceWriter pw) {
		MetamodelField3_0 field = ((AttributeMapping3_0) attributeMapping).getMetamodelField();
		if (field != null) {
			this.printFieldOn(field, pw);
		}
	}

	protected void printFieldOn(MetamodelField3_0 field, BodySourceWriter pw) {
	...
	protected void printMemberTypesOn(BodySourceWriter pw, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree, boolean attributesPrinted) {
		Collection<MetamodelSourceType3_0> memberTypes = memberTypeTree.get(this.sourceType.getName());
		if (memberTypes != null) {
			if (attributesPrinted) {
				pw.println();
			}
			for (Iterator<MetamodelSourceType3_0> stream = memberTypes.iterator(); stream.hasNext(); ) {
