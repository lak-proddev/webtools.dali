...
import org.eclipse.jpt.jpa.core.jpa3_0.context.SequenceGenerator3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.context.java.JavaSequenceGenerator3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.resource.java.SequenceGeneratorAnnotation3_0;

/**
 * JPA 2.0 Java sequence generator
 */
public class GenericJavaSequenceGenerator3_0 extends AbstractJavaSequenceGenerator<SequenceGeneratorAnnotation3_0>
		implements JavaSequenceGenerator3_0 {
	...
	public GenericJavaSequenceGenerator3_0(JavaGeneratorContainer parent,
			SequenceGeneratorAnnotation3_0 generatorAnnotation) {
	...
	protected boolean isEquivalentTo_(SequenceGenerator other) {
		return super.isEquivalentTo_(other)
				&& ObjectTools.equals(this.specifiedSchema, ((SequenceGenerator3_0) other).getSpecifiedSchema())
				&& ObjectTools.equals(this.specifiedCatalog, ((SequenceGenerator3_0) other).getSpecifiedCatalog());
	}
}
