 ...
 */
public final class OrderColumnAnnotationDefinition3_0
	implements AnnotationDefinition
{
	// singleton
	private static final AnnotationDefinition INSTANCE = new OrderColumnAnnotationDefinition3_0();
	 ...
	 */
	private OrderColumnAnnotationDefinition3_0() {
		super();
	}
	...
	public Annotation buildNullAnnotation(JavaResourceAnnotatedElement parent) {
		return new NullOrderColumnAnnotation3_0(parent);
	}
