 ...
 * @since 2.3
 */
public interface MetamodelSourceType3_0 {
	 ...
	 * tree.
	 */
	void synchronizeMetamodel(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree);

	/**
	 * Print the body of the source type's metamodel class on the specified
	 * writer, using the specified member type tree.
	 */
	void printBodySourceOn(BodySourceWriter pw, Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree);


	/**
	 * {@link Comparator} that can be used to compare source types.
	 */
	Comparator<MetamodelSourceType3_0> COMPARATOR = new MetamodelSourceTypeComparator();
	class MetamodelSourceTypeComparator
		extends ComparatorAdapter<MetamodelSourceType3_0>
	{
		@Override
		public int compare(MetamodelSourceType3_0 type1, MetamodelSourceType3_0 type2) {
	...
	interface Synchronizer {
		 ...
		 */
		void synchronize(Map<String, Collection<MetamodelSourceType3_0>> memberTypeTree);
