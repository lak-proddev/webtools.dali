 ...
 * @since 2.3
 */
public enum SharedCacheMode3_0 
{
	ALL,
	NONE,
	ENABLE_SELECTIVE,
	...
	public static SharedCacheMode3_0 fromXmlResourceModel(XmlPersistenceUnitCachingType_2_0 sharedCacheMode) {
	...
	public static XmlPersistenceUnitCachingType_2_0 toXmlResourceModel(SharedCacheMode3_0 sharedCacheMode) {
		if (sharedCacheMode == null) {
			return null;
		}
		switch (sharedCacheMode) {
