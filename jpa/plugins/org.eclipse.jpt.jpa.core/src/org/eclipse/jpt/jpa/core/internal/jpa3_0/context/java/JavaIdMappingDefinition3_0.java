	...
	extends JavaAttributeMappingDefinitionWrapper
{
	...
	// singleton
	private static final JavaAttributeMappingDefinition INSTANCE = new JavaIdMappingDefinition3_0();
	...
	private boolean attributeHasManyToOneMapping(JavaSpecifiedPersistentAttribute persistentAttribute) {
		return JavaManyToOneMappingDefinition3_0.instance().isSpecified(persistentAttribute);
	}

	private boolean attributeHasOneToOneMapping(JavaSpecifiedPersistentAttribute persistentAttribute) {
		return JavaOneToOneMappingDefinition3_0.instance().isSpecified(persistentAttribute);
	}
