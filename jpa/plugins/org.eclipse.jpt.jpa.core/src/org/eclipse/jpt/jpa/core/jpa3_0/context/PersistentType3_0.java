 ...
 * @since 2.3
 */
public interface PersistentType3_0
	extends PersistentType, MetamodelSourceType3_0
{
	/**
	 ...
	 */
	PersistentType3_0 getMetamodelType();
	Transformer<PersistentType3_0, PersistentType3_0> METAMODEL_TYPE_TRANSFORMER = new MetamodelTypeTransformer();
	class MetamodelTypeTransformer
		extends TransformerAdapter<PersistentType3_0, PersistentType3_0>
	{
		@Override
		public PersistentType3_0 transform(PersistentType3_0 pt) {
