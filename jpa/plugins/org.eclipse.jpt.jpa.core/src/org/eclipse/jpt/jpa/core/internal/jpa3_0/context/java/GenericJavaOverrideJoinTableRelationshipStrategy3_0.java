...
public class GenericJavaOverrideJoinTableRelationshipStrategy3_0
	extends AbstractJavaJoinTableRelationshipStrategy<JavaSpecifiedOverrideRelationship2_0>
{
	public GenericJavaOverrideJoinTableRelationshipStrategy3_0(JavaSpecifiedOverrideRelationship2_0 parent) {
		super(parent);
	}
