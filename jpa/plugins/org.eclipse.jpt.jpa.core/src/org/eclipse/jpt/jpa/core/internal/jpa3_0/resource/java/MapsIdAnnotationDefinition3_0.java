 ...
 */
public class MapsIdAnnotationDefinition3_0
	implements AnnotationDefinition
{
	// singleton
	private static final AnnotationDefinition INSTANCE = new MapsIdAnnotationDefinition3_0();
	 ...
	 */
	private MapsIdAnnotationDefinition3_0() {
		super();
	}
	...
	public Annotation buildNullAnnotation(JavaResourceAnnotatedElement parent) {
		return new NullMapsIdAnnotation3_0(parent);
	}
