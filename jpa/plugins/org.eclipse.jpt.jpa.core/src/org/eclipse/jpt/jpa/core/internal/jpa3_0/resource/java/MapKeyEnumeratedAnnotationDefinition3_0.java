 ...
 */
public final class MapKeyEnumeratedAnnotationDefinition3_0
	implements AnnotationDefinition
{
	// singleton
	private static final AnnotationDefinition INSTANCE = new MapKeyEnumeratedAnnotationDefinition3_0();
	 ...
	 */
	private MapKeyEnumeratedAnnotationDefinition3_0() {
		super();
	}
	...
	public Annotation buildNullAnnotation(JavaResourceAnnotatedElement parent) {
		return new NullMapKeyEnumeratedAnnotation3_0(parent);
	}
