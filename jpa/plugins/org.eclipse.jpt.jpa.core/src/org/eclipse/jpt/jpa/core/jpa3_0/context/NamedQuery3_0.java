 ...
 * @since 2.3
 */
public interface NamedQuery3_0
	extends NamedQuery
{
	// ********** lock mode **********
	 ...
	 * lock mode.
	 */
	LockModeType3_0 getLockMode();
	LockModeType3_0 getSpecifiedLockMode();
	void setSpecifiedLockMode(LockModeType3_0 lockMode);
		String SPECIFIED_LOCK_MODE_PROPERTY = "specifiedLockMode"; //$NON-NLS-1$
	LockModeType3_0 getDefaultLockMode();
