 ...
 * @since 2.3
 */
public interface Orderable3_0 extends Orderable {
	...
	/**
	 * If true, will have orderColumn metadata that takes precedence over other
	 * metadata
	 */
	boolean isOrderColumnOrdering();

	/**
	 * Will set orderColumnOrdering to true (will remove all other metadata, and
	 * will set orderColumn to null)
	 */
	 ...
	 */
	SpecifiedOrderColumn3_0 getOrderColumn();
	...
	interface ParentAdapter<M extends AttributeMapping> {
		 ...
		 */
		class Null<M extends AttributeMapping> implements ParentAdapter<M> {
