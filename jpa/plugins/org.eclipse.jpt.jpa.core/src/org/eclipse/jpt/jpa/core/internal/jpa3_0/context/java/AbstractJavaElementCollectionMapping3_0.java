...
import org.eclipse.jpt.jpa.core.jpa3_0.context.CollectionTable3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.context.ManyToOneRelationship3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.context.MetamodelField3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.context.OneToOneRelationship3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.context.SpecifiedPersistentAttribute3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.context.java.JavaAssociationOverrideContainer3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.context.java.JavaAttributeOverrideContainer3_0;
...
import org.eclipse.jpt.jpa.core.jpa3_0.resource.java.MapKeyClassAnnotation3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.resource.java.MapKeyColumnAnnotation3_0;
import org.eclipse.jpt.jpa.core.jpa3_0.resource.java.MapKeyJoinColumnAnnotation3_0;
...
public abstract class AbstractJavaElementCollectionMapping3_0 extends
	...
	protected final JavaOrderable3_0 orderable;

	protected final JavaCollectionTable3_0 collectionTable;
	...
	protected final ContextListContainer<JavaSpecifiedJoinColumn, MapKeyJoinColumnAnnotation3_0> specifiedMapKeyJoinColumnContainer;
	...
	protected String buildSpecifiedTargetClass() {
		ElementCollectionAnnotation3_0 annotation = this.getMappingAnnotation();
	...
	protected JavaOrderable3_0 buildOrderable() {
		return this.getJpaFactory().buildJavaOrderable(this.buildOrderableParentAdapter());
	}

	protected JavaOrderable3_0.ParentAdapter buildOrderableParentAdapter() {
	...
	public JavaCollectionTable3_0 getCollectionTable() {
		return this.collectionTable;
	}

	protected JavaCollectionTable3_0 buildCollectionTable() {
		return this.getJpaFactory().buildJavaCollectionTable(this.buildCollectionTableParentAdapter());
	}

	protected JavaCollectionTable3_0.ParentAdapter buildCollectionTableParentAdapter() {
	...
	public void setSpecifiedMapKeyClass(String mapKeyClass) {
		if (ObjectTools.notEquals(mapKeyClass, this.specifiedMapKeyClass)) {
			MapKeyClassAnnotation3_0 annotation = this.getMapKeyClassAnnotation();
			if (mapKeyClass == null) {
				if (annotation != null) {
	...
	protected void removeMapKeyColumnAnnotation() {
		this.getResourceAttribute().removeAnnotation(MapKeyColumnAnnotation3_0.ANNOTATION_NAME);
	}
	...
	public JavaSpecifiedJoinColumn addSpecifiedMapKeyJoinColumn(int index) {
		MapKeyJoinColumnAnnotation3_0 annotation = this.addMapKeyJoinColumnAnnotation(index);
	...
	protected JavaSpecifiedJoinColumn buildMapKeyJoinColumn(MapKeyJoinColumnAnnotation3_0 joinColumnAnnotation) {
	...
	protected ListIterable<NestableAnnotation> getNestableMapKeyJoinColumnAnnotations() {
		return this.getResourceAttribute().getAnnotations(MapKeyJoinColumnAnnotation3_0.ANNOTATION_NAME);
	}
	...
	protected void removeMapKeyJoinColumnAnnotation(int index) {
		this.getResourceAttribute().removeAnnotation(index, MapKeyJoinColumnAnnotation3_0.ANNOTATION_NAME);
	}
	...
	@Override
	protected JpaFactory3_0 getJpaFactory() {
		return (JpaFactory3_0) super.getJpaFactory();
	}

	public String getKey() {
		return MappingKeys3_0.ELEMENT_COLLECTION_ATTRIBUTE_MAPPING_KEY;
	}

	@Override
	protected String getAnnotationName() {
		return ElementCollectionAnnotation3_0.ANNOTATION_NAME;
	}
	...
	protected String getMetamodelFieldTypeName() {
		return ((SpecifiedPersistentAttribute3_0) this.getPersistentAttribute()).getMetamodelContainerFieldTypeName();
	}
	...
	public abstract class AbstractParentAdapter {
		public JavaResourceMember getResourceMember() {
			return AbstractJavaElementCollectionMapping3_0.this.getResourceAttribute();
		}

		public TypeMapping getTypeMapping() {
			return AbstractJavaElementCollectionMapping3_0.this.getTypeMapping();
		}
		...
		public org.eclipse.jpt.jpa.db.Table resolveDbTable(String tableName) {
			JavaCollectionTable3_0 table = this.getCollectionTable();
		...
		public TextRange getValidationTextRange() {
			return AbstractJavaElementCollectionMapping3_0.this.getValidationTextRange();
		}

		protected String getMappingName() {
			return AbstractJavaElementCollectionMapping3_0.this.getName();
		}
		...
		protected JavaSpecifiedPersistentAttribute getPersistentAttribute() {
			return AbstractJavaElementCollectionMapping3_0.this.getPersistentAttribute();
		}
	}
	...
	public class ValueColumnParentAdapter extends AbstractParentAdapter implements JavaSpecifiedColumn.ParentAdapter {
		...
		public CompleteColumnAnnotation getColumnAnnotation() {
			return AbstractJavaElementCollectionMapping3_0.this.getValueColumnAnnotation();
		}

		public void removeColumnAnnotation() {
			AbstractJavaElementCollectionMapping3_0.this.removeValueColumnAnnotation();
		}
	...
	public class MapKeyColumnParentAdapter extends AbstractParentAdapter implements JavaSpecifiedColumn.ParentAdapter {
		...
		public MapKeyColumnAnnotation3_0 getColumnAnnotation() {
			return AbstractJavaElementCollectionMapping3_0.this.getMapKeyColumnAnnotation();
		}

		public void removeColumnAnnotation() {
			AbstractJavaElementCollectionMapping3_0.this.removeMapKeyColumnAnnotation();
		}
	...
	public abstract class ValueOverrideContainerParentAdapter extends AbstractParentAdapter {
		...
		public TypeMapping getOverridableTypeMapping() {
			return AbstractJavaElementCollectionMapping3_0.this.getResolvedTargetEmbeddable();
		}
	...
	public class MapKeyJoinColumnParentAdapter implements JoinColumn.ParentAdapter {
		...
		public String getDefaultTableName() {
			return AbstractJavaElementCollectionMapping3_0.this.getCollectionTable().getName();
		}

		public String getDefaultColumnName(NamedColumn column) {
			return AbstractJavaElementCollectionMapping3_0.this.getName() + "_KEY"; //$NON-NLS-1$
		}
		...
		public Entity getRelationshipTarget() {
			return AbstractJavaElementCollectionMapping3_0.this.getResolvedMapKeyEntity();
		}
		...
		public org.eclipse.jpt.jpa.db.Table resolveDbTable(String tableName) {
			return AbstractJavaElementCollectionMapping3_0.this.getCollectionTable().getDbTable();
		}

		public org.eclipse.jpt.jpa.db.Table getReferencedColumnDbTable() {
			return AbstractJavaElementCollectionMapping3_0.this.getResolvedMapKeyEntity().getPrimaryDbTable();
		}

		public int getJoinColumnsSize() {
			return AbstractJavaElementCollectionMapping3_0.this.getMapKeyJoinColumnsSize();
		}
	...
	public class MapKeyAttributeOverrideContainerParentAdapter extends AbstractParentAdapter
		...
		public TypeMapping getOverridableTypeMapping() {
			return AbstractJavaElementCollectionMapping3_0.this.getResolvedMapKeyEmbeddable();
		}
		...
		public boolean isRelevant(String overrideName) {
			if (AbstractJavaElementCollectionMapping3_0.this.getValueType() != Type.EMBEDDABLE_TYPE) {
				return true;
			}
