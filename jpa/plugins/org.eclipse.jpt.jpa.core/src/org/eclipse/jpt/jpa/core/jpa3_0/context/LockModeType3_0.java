...
public enum LockModeType3_0 {
	...
	LockModeType3_0(org.eclipse.jpt.jpa.core.jpa2.resource.java.LockModeType_2_0 javaLockModeType, org.eclipse.jpt.jpa.core.resource.orm.v2_0.LockModeType_2_0 ormLockModeType) {
	...
	public static LockModeType3_0 fromJavaResourceModel(org.eclipse.jpt.jpa.core.jpa2.resource.java.LockModeType_2_0 javaLockModeType) {
		return (javaLockModeType == null) ? null : fromJavaResourceModel_(javaLockModeType);
	}

	private static LockModeType3_0 fromJavaResourceModel_(org.eclipse.jpt.jpa.core.jpa2.resource.java.LockModeType_2_0 javaLockModeType) {
		for (LockModeType3_0 lockModeType : LockModeType3_0.values()) {
	...
	public static org.eclipse.jpt.jpa.core.jpa2.resource.java.LockModeType_2_0 toJavaResourceModel(LockModeType3_0 lockModeType) {
		return (lockModeType == null) ? null : lockModeType.getJavaLockModeType();
	}


	public static LockModeType3_0 fromOrmResourceModel(org.eclipse.jpt.jpa.core.resource.orm.v2_0.LockModeType_2_0 ormLockModeType) {
		return (ormLockModeType == null) ? null : fromOrmResourceModel_(ormLockModeType);
	}

	private static LockModeType3_0 fromOrmResourceModel_(org.eclipse.jpt.jpa.core.resource.orm.v2_0.LockModeType_2_0 ormLockModeType) {
		for (LockModeType3_0 lockModeType : LockModeType3_0.values()) {
	...
	public static org.eclipse.jpt.jpa.core.resource.orm.v2_0.LockModeType_2_0 toOrmResourceModel(LockModeType3_0 lockModeType) {
