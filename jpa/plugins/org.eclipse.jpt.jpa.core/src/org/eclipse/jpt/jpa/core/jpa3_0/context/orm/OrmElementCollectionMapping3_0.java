 ...
 * @since 2.3
 */
public interface OrmElementCollectionMapping3_0
	extends ElementCollectionMapping2_0, OrmCollectionMapping3_0, OrmConvertibleMapping
{
	XmlElementCollection getXmlAttributeMapping();

	OrmCollectionTable3_0 getCollectionTable();
