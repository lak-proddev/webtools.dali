 ...
 */
public final class GeneratedAnnotationDefinition3_0
	implements AnnotationDefinition
{
	// singleton
	private static final GeneratedAnnotationDefinition3_0 INSTANCE = new GeneratedAnnotationDefinition3_0();

	/**
	 * Return the singleton.
	 */
	public static GeneratedAnnotationDefinition3_0 instance() {
		return INSTANCE;
	}
	 ...
	 */
	private GeneratedAnnotationDefinition3_0() {
		super();
	}
