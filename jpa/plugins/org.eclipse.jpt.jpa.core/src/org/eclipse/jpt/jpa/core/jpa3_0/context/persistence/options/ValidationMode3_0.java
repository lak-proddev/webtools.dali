...
*******************************************************************************/
package org.eclipse.jpt.jpa.core.jpa3_0.context.persistence.options;
...
public enum ValidationMode3_0 
{
	...
	ValidationMode3_0(XmlPersistenceUnitValidationModeType_2_0 xmlEnumValue) {
	...
	public static ValidationMode3_0 fromXmlResourceModel(XmlPersistenceUnitValidationModeType_2_0 xmlValidationMode) {
		return (xmlValidationMode == null) ? null : fromXmlResourceModel_(xmlValidationMode);
	}

	private static ValidationMode3_0 fromXmlResourceModel_(XmlPersistenceUnitValidationModeType_2_0 xmlValidationMode) {
		for (ValidationMode3_0 validationMode : ValidationMode3_0.values()) {
	...
	public static XmlPersistenceUnitValidationModeType_2_0 toXmlResourceModel(ValidationMode3_0 validationMode) {
