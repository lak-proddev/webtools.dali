 ...
 * @since 3.3
 */
public interface NamedStoredProcedureQueryAnnotation3_0 extends QueryAnnotation {
	String ANNOTATION_NAME = JPA3_0.NAMED_STORED_PROCEDURE_QUERY;

	// ********** procedure name **********

	/**
	 * Corresponds to the 'procedureName' element of the NamedStoredProcedureQuery
	...
	/**
	 * Corresponds to the 'procedureName' element of the NamedStoredProcedureQuery
	 * annotation. Set to null to remove the element.
	 */
	void setProcedureName(String procedureName);

	/**
	 * Return the {@link TextRange} for the 'procedureName' element. If element does
	 * not exist return the {@link TextRange} for the NamedStoredProcedureQuery
	 * annotation.
	 */
	...
	/**
	 * Corresponds to the 'parameters' element of the NamedStoredProcedureQuery
	 * annotation. Return an empty iterator if the element does not exist in Java.
	 */
	ListIterable<StoredProcedureParameterAnnotation3_0> getParameters();
	 ...
	 * annotation.
	 */
	StoredProcedureParameterAnnotation3_0 parameterAt(int index);

	/**
	 * Corresponds to the 'parameters' element of the NamedStoredProcedureQuery
	 * annotation.
	 */
	StoredProcedureParameterAnnotation3_0 addParameter(int index);
	...
	/**
	 * Corresponds to the 'resultClasses' element of the NamedStoredProcedureQuery
	 * annotation. Return an empty iterator if the element does not exist in Java.
	 */
	...
	/**
	 * Corresponds to the 'resultSetMappings' element of the
	 * NamedStoredProcedureQuery annotation. Return an empty iterator if the element
