 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.jpt.jpa.core.resource.orm.v3_0.OrmV3_0Package#getParameterMode_3_0()
 * @model
 * @generated
 */
public enum ParameterMode_3_0 implements Enumerator
{
	/**
	 ...
	 * @generated
	 */
	private static final ParameterMode_3_0[] VALUES_ARRAY =
		new ParameterMode_3_0[]
		{
			IN,
			INOUT,
			OUT,
	 ...
	 * @generated
	 */
	public static final List<ParameterMode_3_0> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static ParameterMode_3_0 get(String literal)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			ParameterMode_3_0 result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ParameterMode_3_0 getByName(String name)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			ParameterMode_3_0 result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static ParameterMode_3_0 get(int value)
	{
		switch (value)
		{
	 ...
	 * @generated
	 */
	private ParameterMode_3_0(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
